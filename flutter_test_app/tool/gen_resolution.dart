...
void main() {
  ...
  final newContent = content.replaceFirst("'Hello Live Flutter Editing'", "'Hello Flutter MCP Demo'");
...
+                    'Hello Flutter MCP Demo',
  ...
  final proposal = <String, Object>{
    ...
    'expectedRuntimeEffects': <String>['Header section heading displays "Hello Flutter MCP Demo".'],
