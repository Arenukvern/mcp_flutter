...
| `hover`                           | ✅ `hover` *(P2, shipped 2026-04-27)*           | Three-event sequence: `PointerAddedEvent` → off-screen hover → target hover. Drives `MouseRegion.onEnter`. Desktop/web only. Latent DPR bug discovered during impl — see `todo/dpr_resolve_center_bounds.md`. |
