...
This document is written for contributors and agents who need to decide which
layer to change.
...
- [IntentCall consumer guide](docs/intentcall/README.md)
- [mcp_toolkit README](mcp_toolkit/README.md)
