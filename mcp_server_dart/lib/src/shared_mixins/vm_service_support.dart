...
import 'package:flutter_inspector_mcp_server/src/shared_core/services/flutter_tool_machine_discovery.dart';
...
base mixin VMServiceSupport on BaseMCPToolkitServer {
  ...
  Future<List<FlutterMachineDiscoveryTarget>> _discoverMachineTargets() =>
      _flutterMachineDiscovery.discover(
        projectDir: configuration.flutterProjectDir,
        device: configuration.flutterDevice,
        timeout: Duration(
          milliseconds: configuration.flutterDiscoveryTimeoutMs,
        ),
      );
