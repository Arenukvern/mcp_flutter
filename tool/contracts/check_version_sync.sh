...
RUNTIME_VERSION_FILE="$ROOT_DIR/mcp_shared_core/lib/src/runtime_version.dart"
FMT_CAPABILITY_FILE="$ROOT_DIR/mcp_capability_core/lib/src/fmt_capability.dart"
