...
This project is indexed by GitNexus as **mcp_flutter** (5360 symbols, 11649 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
