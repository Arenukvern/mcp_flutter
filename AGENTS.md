...
This project is indexed by GitNexus as **mcp_flutter** (4612 symbols, 10433 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
