...
| Hosted deps only in `pubspec.yaml` | `flutter_mcp_toolkit_core: ^4.0.0-dev.9` |
| Publish **after** `flutter_mcp_toolkit_core` `4.0.0-dev.9` is on pub.dev | Required for consumers |
