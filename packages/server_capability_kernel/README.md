...
| Hosted deps only in `pubspec.yaml` | `flutter_mcp_toolkit_core: ^4.0.0-dev.4` |
| Publish **after** `flutter_mcp_toolkit_core` `4.0.0-dev.4` is on pub.dev | Required for consumers |
