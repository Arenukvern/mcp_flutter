...
```yaml
dependencies:
  flutter_mcp_toolkit_capability_core: ^4.0.0-dev.9
  flutter_mcp_toolkit_capability_kernel: ^4.0.0-dev.9
  flutter_mcp_toolkit_core: ^4.0.0-dev.9
```
...
| Hosted sibling deps in `pubspec.yaml` | kernel + core `^4.0.0-dev.9` |
| Publish **after** kernel and core `4.0.0-dev.9` on pub.dev | Required |
