...
```yaml
dependencies:
  flutter_mcp_toolkit_capability_core: ^5.0.3
  flutter_mcp_toolkit_capability_kernel: ^5.0.3
  flutter_mcp_toolkit_core: ^5.0.3
```
...
| Hosted sibling deps in `pubspec.yaml` | kernel + core `^5.0.3` |
| Publish **after** kernel and core `5.0.3` on pub.dev | Required |
