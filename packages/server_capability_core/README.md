...
```yaml
dependencies:
  flutter_mcp_toolkit_capability_core: ^5.0.4
  flutter_mcp_toolkit_capability_kernel: ^5.0.4
  flutter_mcp_toolkit_core: ^5.0.4
```
...
| Hosted sibling deps in `pubspec.yaml` | kernel + core `^5.0.4` |
| Publish **after** kernel and core `5.0.4` on pub.dev | Required |
