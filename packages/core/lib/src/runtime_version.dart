...
const kFlutterMcpVersion = '5.0.0'; // x-release-please-version
const kFlutterMcpMajorVersion = 5; // x-release-please-major
...
const kFlutterMcpProtocolVersion =
    'flutter-mcp-toolkit/5.0'; // x-release-please-major
