...
Map<String, Object?> inputSchemaFromDynamicRegistrationMap(
...
Map<String, Object?> clientResourceReadInputSchema() => <String, Object?>{
  'type': 'object',
  'additionalProperties': false,
  'required': <String>['uri'],
  'properties': <String, Object?>{
...
Map<String, Object?> clientResourceTemplateReadInputSchema() =>
    <String, Object?>{
      'type': 'object',
      'additionalProperties': false,
      'required': <String>['uri'],
...
Map<String, Object?> _deepCopySchemaMap(final Map<Object?, Object?> raw) =>
    raw.map(
