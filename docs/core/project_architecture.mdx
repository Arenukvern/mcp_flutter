...
- [Installation Guide](/getting_started/manual_installation)
- [Configuration Guide](/core/mcp_configuration)
- [Dynamic Tools Registry](/core/dynamic_tools_registry)
- [Contributing Guidelines](/contributing/contribution_guide)
...
- Registers custom Dart VM Service extensions (e.g., `ext.mcp.toolkit.app_errors`, `ext.mcp.toolkit.view_screenshots`, `ext.mcp.toolkit.inspect_widget_at_point`).
