# intentcall Phase 4 — Registry-backed resources (closure)
...
| Command | Result |
|---------|--------|
| `dart test packages/intentcall_mcp` | pass (6) |
| `dart test packages/intentcall_webmcp` | pass (2) |
...
Merge `feat/intentcall-phase1-3` when ready; run full `mcp_server_dart` test suite in CI before release.
