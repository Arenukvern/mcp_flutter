# intentcall Phase 6 — MCPCallEntry → AgentCallEntry migration
...
| `import 'package:mcp_toolkit/mcp_toolkit.dart';` only | Adds `intentcall_core` + `intentcall_schema` imports when needed |
...
- [Phase 6 spec](../superpowers/specs/2026-05-26-intentcall-pre-extract-completion-design.md)
- [What's next](../superpowers/WHATS_NEXT.md) — forward index
- [Phase 7 extract](../superpowers/plans/2026-05-27-intentcall-phase7-extract.md) — active extract work
- [Integration completion plan](../superpowers/plans/archive/2026-05-26-intentcall-integration-completion-next.md) — archived (complete 2026-05-27)
...
flutter-mcp-toolkit init intentcall-platform --check --project-dir path/to/flutter_app
```
