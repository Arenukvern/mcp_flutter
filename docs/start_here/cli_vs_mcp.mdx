...
1. Use MCP in editor/chat for day-to-day debugging and iteration.
2. Use CLI in CI or local scripts to create reproducible diagnostics artifacts.
3. Share output or artifacts back into assistant workflows.

## Decision Guide

- Need interactive assistant workflow right now: use MCP.
- Need deterministic automation or CI: use CLI.
- Need both interactive and reproducible workflows: use both.
