...
- `flutter-mcp-toolkit`: direct command-line interface for scripts, CI, snapshots, and deterministic automation.
...
| Topic | CLI (`flutter-mcp-toolkit`) | MCP Server (`flutter-mcp-toolkit-server`) |
| --- | --- | --- |
