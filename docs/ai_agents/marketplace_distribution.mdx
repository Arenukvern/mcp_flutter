...
3. For custom tools: register `AgentCallEntry` in app code; see [Dynamic tool registry](/core/dynamic_tools_registry) and skill `flutter-mcp-toolkit-custom-tools`.
