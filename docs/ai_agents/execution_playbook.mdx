...
2. "Get view details (layout metadata)"
3. "Get app errors"
4. Optional when server was started with `--dumps`: "Dump render tree"
5. After any code edit: "Hot reload and take another screenshot"

Use before/after screenshots and view details as proof that the runtime change actually took effect.
