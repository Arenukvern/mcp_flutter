// flutter_mcp_toolkit_core/lib/src/connection/connection_override.dart
// Copyright (c) 2025, Flutter Inspector MCP Server authors.
// Licensed under the MIT License.

// Pure connection-override parsing and schema helpers.
// No dart_mcp, no dart:io, no transport dependencies.

import '../commands/core_commands.dart';
import '../types/error_codes.dart';
...
ConnectionArgsResolution resolveCommandArgumentsForExecution({
  ...
  final conflictingNativeFields = _nativeSelectorFields(
    commandName,
  ).where(sanitized.containsKey).toList()..sort();
